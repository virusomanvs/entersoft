<?php get_header(); ?>
        ...
        <div class="shell">
            <div class="range range-70 range-sm-center range-lg-justify">
                <div class="cell-sm-10 cell-md-6 cell-lg-5">
                    ...
                    <h4>Наши цели</h4>
                    <p>Постоянное совершенствование методик работы, применение передовых технологий,
                        отбор и обучение персонала, стремление находиться на пике технологического прогресса
                        позволяет нам внедрять нашим клиентам лучшие решения в сфере предлагаемых нами услуг.</p>
                </div>
                <div class="cell-sm-10 cell-md-6">
                    <div class="row grid-2">
                        <div class="col-xs-6"><img src="<?php bloginfo('template_url'); ?>/images/about-1-273x214.jpg" alt="" width="273" height="214"/>
						<img src="<?php bloginfo('template_url'); ?>/images/about-2-273x214.jpg" alt="" width="273" height="214"/>
                        </div>
    ...
    <main class="page-content">
        <section class="bg-images-2 section-80 section-md-bottom-190 section-lg-top-80">
            ...
            <div class="range range-50 range-sm-center range-md-left range-lg-justify">
                <div class="cell-sm-10 cell-md-6">
                    ...
                    <div class="group-3-columns" data-lightgallery="group">
                        ...
                        <div class="column-item"><a class="thumb-elegant" href="<?php bloginfo('template_url'); ?>/images/image-2-1200x800_original.jpg" data-lightgallery="group-item"><img src="<?php bloginfo('template_url'); ?>/images/image-2-166x139.jpg" alt="" width="166" height="139"/>
                                <div class="thumb-elegant__overlay"></div></a></div>
