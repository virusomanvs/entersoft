							...
							<div class="wpcf7" dir="ltr" id="wpcf7-f174-o1" lang="ru-RU" role="form">
								...
								<form action="/#wpcf7-f174-o1" class="wpcf7-form" method="post" novalidate="novalidate">
                                    ...
                                    <div class="fw-mt-15 row">
                                        <div class="col-md-6"><a class="button button-icon button-icon-right button-default-outline button-block" href="/price/?type=sol&search=<?php echo the_title() ?>"><span class="icon material-icons-view_list"></span>Узнать цену</a></div>
                ...
                <div class="cell-md-8 cell-lg-12 blog__main">
                    <article class="post-single">
                        ...
                        <div class="post-single__footer">
                            <div class="row">
                                <div class="col-md-6"><a class="button button-block button-primary button-icon button-icon-right" href="/price/?type=sol&search=<?php echo the_title() ?>"><span class="icon material-icons-view_list"></span>Узнать цену</a></div>
