							...
							<div class="wpcf7" dir="ltr" id="wpcf7-f174-o1" lang="ru-RU" role="form">
								...
								<form action="/#wpcf7-f174-o1" class="wpcf7-form" method="post" novalidate="novalidate">
									<div style="display: none;">
										<input name="_wpcf7" type="hidden" value="174"> <input data-constraints="@Required" name="_wpcf7_version" type="hidden" value="5.0"> <input name="_wpcf7_locale" type="hidden" value="ru_RU"> <input name="_wpcf7_unit_tag" type="hidden" value="wpcf7-f174-o1"> <input name="_wpcf7_container_post" type="hidden" value="0">
									</div>
									<div class="fw-mt-15">
										<div class="form-wrap">
